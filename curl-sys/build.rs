...
fn main() {
    ...
    cfg.out_dir(&build)
        ...
        .file("curl/lib/ws.c")
        .file("curl/lib/easyoptions.c")
        .file("curl/lib/dict.c")
        .file("curl/lib/httpsrr.c")
        .file("curl/lib/psl.c")
        .file("curl/lib/easygetopt.c")
        .file("curl/lib/tftp.c")
        .file("curl/lib/cf-ip-happy.c")
        .file("curl/lib/curl_rtmp.c")
        .file("curl/lib/hostip4.c")
        .file("curl/lib/openldap.c")
        .file("curl/lib/krb5.c")
        .file("curl/lib/smtp.c")
        .file("curl/lib/memdebug.c")
        ...
        .file("curl/lib/curl_sasl.c")
        .file("curl/lib/dllmain.c")
        .file("curl/lib/smb.c")
        .file("curl/lib/vauth/gsasl.c")
        .file("curl/lib/vauth/oauth2.c")
        .file("curl/lib/vauth/cram.c")
        .file("curl/lib/vauth/cleartext.c")
        .file("curl/lib/vauth/krb5_gssapi.c")
        .file("curl/lib/vtls/mbedtls.c")
        .file("curl/lib/vtls/gtls.c")
        .file("curl/lib/vtls/rustls.c")
        .file("curl/lib/vtls/cipher_suite.c")
        .file("curl/lib/vtls/vtls_spack.c")
        .file("curl/lib/vtls/wolfssl.c")
        .file("curl/lib/vtls/mbedtls_threadlock.c")
        .file("curl/lib/vssh/libssh.c")
        .file("curl/lib/vssh/libssh2.c")
        .file("curl/lib/vssh/curl_path.c")
        .file("curl/lib/vssh/wolfssh.c")
        .file("curl/lib/asyn-ares.c")
        .file("curl/lib/imap.c")
        .file("curl/lib/fake_addrinfo.c")
